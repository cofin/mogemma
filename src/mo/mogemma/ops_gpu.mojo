...
struct GPUBackend(ComputeBackend):
    ...
    @always_inline
    def context(self) -> UnsafePointer[DeviceContext, MutAnyOrigin]:
        return UnsafePointer[DeviceContext, MutAnyOrigin](unsafe_from_address=self.ctx)
    ...
    def vec_mat_mul(
        ...
        try:
            ...
            self.context()[].enqueue_function[vec_mat_mul_kernel](
                out_ptr,
                x_ptr,
                w_ptr,
                in_dim,
    ...
    def vec_mat_mul_i8(
        ...
        try:
            var grid = ceildiv(out_dim, BLOCK_1D)
            self.context()[].enqueue_function[vec_mat_mul_i8_kernel](
                out_ptr,
                x_ptr,
                w_ptr,
                scale_ptr,
    ...
    def mat_mat_mul(
        ...
        try:
            ...
            self.context()[].enqueue_function[mat_mat_mul_kernel](
                out_ptr,
                x_ptr,
                w_ptr,
                batch_size,
    ...
    def rms_norm(
        ...
        try:
            ...
            if block <= 1024:
                ...
                self.context()[].enqueue_function[rms_norm_kernel[1024]](
                    out_ptr,
                    x_ptr,
                    weight_ptr,
                    size,
    ...
    def softmax(
        ...
        try:
            if size <= 1024:
                self.context()[].enqueue_function[softmax_strided_kernel[1024]](
                    vec_ptr,
                    size,
                    grid_dim=1,
                    block_dim=1024,
    ...
    def rope_rotate(
        ...
        try:
            ...
            self.context()[].enqueue_function[rope_rotate_kernel](
                vec_ptr,
                cos_ptr,
                sin_ptr,
                half_dim,
    ...
    def geglu(
        ...
        try:
            ...
            self.context()[].enqueue_function[geglu_kernel](
                out_ptr,
                gate_ptr,
                up_ptr,
                size,
    ...
    def gelu(
        ...
        try:
            var grid = ceildiv(size, BLOCK_1D)
            self.context()[].enqueue_function[gelu_kernel](
                out_ptr,
                x_ptr,
                size,
                grid_dim=grid,
    ...
    def copy(
        ...
        try:
            var grid = ceildiv(size, BLOCK_1D)
            self.context()[].enqueue_function[copy_kernel](
                dst_ptr,
                src_ptr,
                size,
                grid_dim=grid,
    ...
    def embed_lookup(
        ...
        try:
            ...
            self.context()[].enqueue_function[embed_lookup_kernel](
                out_ptr,
                embed_table_ptr,
                token_id,
                hidden_size,
    ...
    def vector_add(
        ...
        try:
            var grid = ceildiv(size, BLOCK_1D)
            self.context()[].enqueue_function[vector_add_kernel](
                out_ptr,
                a_ptr,
                b_ptr,
                size,
    ...
    def vector_add_scaled(
        ...
        try:
            var grid = ceildiv(size, BLOCK_1D)
            self.context()[].enqueue_function[vector_add_scaled_kernel](
                out_ptr,
                a_ptr,
                b_ptr,
                scale,
    ...
    def average_pool_2d(
        ...
        try:
            ...
            var block = optimal_block_size(hidden_size)
            self.context()[].enqueue_function[average_pool_2d_kernel](
                out_ptr,
                x_ptr,
                out_h,
                out_w,
    ...
    def top_k(
        ...
        try:
            self.context()[].enqueue_function[top_k_kernel](
                values_ptr,
                k,
                size,
                out_indices_ptr,
    ...
    def kv_write(
        ...
        try:
            ...
            if block > 1024:
                block = 1024
            self.context()[].enqueue_function[kv_write_kernel](
                dst_ptr,
                src_ptr,
                kv_size,
                pos,
    ...
    def attention_scores(
        ...
        try:
            ...
            if block > 256:
                block = 256
            self.context()[].enqueue_function[attention_scores_kernel](
                scores_ptr,
                q_ptr,
                k_cache_ptr,
                num_heads,
    ...
    def attention_value_accum(
        ...
        try:
            ...
            if block > 256:
                block = 256
            self.context()[].enqueue_function[attention_value_accum_kernel](
                out_ptr,
                scores_ptr,
                v_cache_ptr,
                num_heads,
