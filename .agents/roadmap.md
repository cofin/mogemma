...
- [x] Hugging Face Hub integration (auto-download/cache). *(Skipped for now)*
- [x] Fully async Python API. *(Completed)*
- [x] Comprehensive CLI for model management. *(Skipped for now)*
